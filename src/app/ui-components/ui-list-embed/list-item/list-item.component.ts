// src/app/ui-components/list-item/list-item.component.ts
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, MatTooltipModule, MatIconModule, MatInputModule, MatButtonModule, MatSelectModule, DragDropModule],
