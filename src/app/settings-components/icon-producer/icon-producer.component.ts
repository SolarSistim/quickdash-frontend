...
@Component({
  ...
  imports: [CommonModule,MatCardModule,MatButtonModule,ImageCropperComponent,FormsModule,MatSelectModule,MatFormFieldModule,MatInputModule,TutorialIconProducerComponent],
...
onImageSelected(event: Event) {
  ...
  if (file) {
    ...
    this.showFormatWarning = ext ? nonTransparentFormats.includes(ext) : false;
